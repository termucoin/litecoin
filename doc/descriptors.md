# Support for Output Descriptors in Teranocoin Core

Since Teranocoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Teranocoin Core wallets, a convenience function `combo` is
