Contributing to Teranocoin Core
============================

The Teranocoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the Teranocoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/teranocoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to teranocoin-qt
...
The following applies to code changes to the Teranocoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Teranocoin
Network Protocol consensus changes.

Whether a pull request is merged into Teranocoin Core rests with the project merge
...
Patches that change Teranocoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Teranocoin consensus, it must have been
...
The project leader is the release manager for each Teranocoin Core release.
