...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " teranocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  teranocoin-tx [options] <hex-tx> [commands]  Update hex-encoded teranocoin transaction\n" +
            "or:     teranocoin-tx [options] -create [commands]   Create hex-encoded teranocoin transaction\n" +
            "\n";
