...
{
    const char* pszTimestamp = "ID Today 17/Aug/2026 Aldianokto, Chaos in the Treasury, Order in the Code";
...
public:
    CMainParams() {
        ...
        consensus.nSubsidyHalvingInterval = 4210000;
        ...
        // vSeeds.emplace_back("seed-a.teranocoin.loshan.co.uk");
...
public:
    CTestNetParams() {
        ...
        // vSeeds.emplace_back("testnet-seed.teranocointools.com");
