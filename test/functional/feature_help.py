...
"""Verify that starting teranocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start teranocoin with -h for help text")
        ...
        self.log.info("Start teranocoin with -version for version information")
        ...
        self.log.info("Start teranocoind with -fakearg to make sure it does not start")
