...
bech32_templates = [
  ...
  ('terano',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('terano',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('terano',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('terano',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tterano',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tterano',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tterano',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tterano',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tterano',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tterano',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tterano',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tterano',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rterano',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rterano',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rterano',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rterano', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tterano',   17, 32, Encoding.BECH32M, False, False, False),
  ('rterano',  3,  1, Encoding.BECH32M, False, False, False),
  ('terano',   15, 41, Encoding.BECH32M, False, False, False),
  ('tterano',    0, 16, Encoding.BECH32,  False, False, False),
  ('rterano',  0, 32, Encoding.BECH32,  True,  False, False),
  ('terano',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tterano',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rterano',  0, 20, Encoding.BECH32,  False, False, True),
  ('terano',    0, 20, Encoding.BECH32M, False, False, False),
  ('tterano',    0, 32, Encoding.BECH32M, False, False, False),
  ('rterano',  0, 20, Encoding.BECH32M, False, False, False),
  ('terano',    1, 32, Encoding.BECH32,  False, False, False),
  ('tterano',    2, 16, Encoding.BECH32,  False, False, False),
  ('rterano', 16, 20, Encoding.BECH32,  False, False, False),
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['terano', 'tterano', 'rterano']:
