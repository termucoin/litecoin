...
Teranocoin is an experimental digital currency that enables instant payments to
anyone, anywhere in the world. Teranocoin uses peer-to-peer technology to operate
with no central authority: managing transactions and issuing money are carried
out collectively by the network. Teranocoin Core is the name of open source
...
Teranocoin Core is released under the terms of the MIT license. See [COPYING](COPYING) for more
...
The developer [mailing list](https://groups.google.com/forum/#!forum/teranocoin-dev)
should be used to discuss complicated or controversial changes before working
on a patch set.

Developer IRC can be found on Freenode at #teranocoin-dev.
...
Translations are converted to Teranocoin periodically.
